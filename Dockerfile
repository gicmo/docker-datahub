...
RUN echo -e "console\ndbwipes" >> /tmp/requirements.txt
RUN rm /tmp/requirements.txt

# datahub setup
RUN thrift --gen py -o /srv/datahub/src/ /srv/datahub/src/datahub.thrift
...
RUN sed -i -e '/import bsddb/d' /srv/datahub/src/apps/dbwipes/summary.py
